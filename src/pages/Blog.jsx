...
<div className='bg-white  text-black  dark:bg-black dark:text-white'>
        ...
        <h1 className='text-5xl text-start font-extrabold p-10'>Check My Articles On</h1>
        ...
        <div>
            <h2 className='text-3xl text-center font-extrabold pt-5'>  My Latest Article </h2>
              <div className='justify-center'>
                ...
                <a href='https://dev.to/oloriasabi/google-oauth2-using-the-new-google-identity-services-sdk-for-react-using-jwt-decode-2ioo'><p className='text-xl font-bold text-center bg-black text-white dark:text-black dark:bg-white w-20 ml-auto mr-auto  hover:scale-x-105  p-5 cursor-pointer'>Link</p></a>
              </div>
        </div>
        </div>
        </div>
