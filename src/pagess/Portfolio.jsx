      ...
      >
         ...
         <SwiperSlide>
          <div className='h-screen overflow-y-scroll overscroll-contain p-10'>
              <h2 className='font-bold text-xl text-center text-gray-500 services'>Works And Freelances</h2>
               <Work/>       
          </div>
         </SwiperSlide>
        ...
        <SwiperSlide>
          <div className='h-screen overflow-y-scroll overscroll-contain p-10'>
          <h2 className='font-bold text-xl text-gray-500 services'>Personal Projects</h2>
          <PersonalProjects />
          </div>
          </SwiperSlide>
